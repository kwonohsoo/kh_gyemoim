  ...
  <div class="container px-5">
    ...
    <form action="/writePost" method="post" enctype="multipart/form-data" id="writeConn">
      ...
      <div class="write-attr">
        ...
        <input type="text" id="write-input-title" name="title" value="" placeholder="제목을 입력해주세요" required>
      </div>
      <div class="write-attr">
        <label class="attr-name" for="write-input-writer">작성자</label>
        <input type="text" id="write-input-writer" name="name" value="" placeholder="제목을 입력해주세요" required>
      </div>
<div class="secret-attr">
      ...
      <div class="write-btn-area text-center">
        <button type="submit" class="btn btn-primary btn-lg px-4 me-sm-3"/>작성하기</button>
      </div>
    </form>
  </div>
  </div>
