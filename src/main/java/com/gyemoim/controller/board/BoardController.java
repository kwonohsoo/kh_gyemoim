...
public class BoardController {
  ...
  private String getSearchList(@ModelAttribute("spv") PageVO spv, Model model, @RequestParam(value = "nowPage", required = false) String nowPage, @RequestParam(value = "cntPerPager", required = false) String cntPerPage) throws Exception {
